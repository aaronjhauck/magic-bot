...
function getSaltyCardArray(size)  { return utils.load(size, helper.getSaltyCard);      }
function getArtifactArray(size)   { return utils.load(size, helper.getTopArtifact);    }
...
module.exports = { 
    ...
    getSaltyCardArray, getArtifactArray
}
